...
Most of these come down to network reality or how paulgraham serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

paulgraham rate-limits like any public site. pg already paces
...
Where a surface is gated, pg reads a cookie or token you supply
...
`pg`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what pg actually did
